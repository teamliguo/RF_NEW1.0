...
//****************************************************************************************************
//FUNCTION:
float hiveRegressionForest::hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, float& voLPPredictSet, float& voMPPredictSet, float& voLLPerdict, float& voLLPSet, float& voMPDissimilarity, float& voIFMPPerdict, bool vIsWeightedPrediction)
{
	...
	return hivePredict(vTestInstance, vForestId, pRegressionForest->getNumOfTrees(), voLPPredictSet, voMPPredictSet, voLLPerdict, voLLPSet, voMPDissimilarity,  voIFMPPerdict, vIsWeightedPrediction);
}
//****************************************************************************************************
//FUNCTION:
float hiveRegressionForest::hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, float& voKnnPredictSet,  float& voVarWiPerdict, bool vIsWeightedPrediction)
{
	_ASSERT(!vTestInstance.empty());
	...
	return hivePredict(vTestInstance, vForestId, pRegressionForest->getNumOfTrees(), voKnnPredictSet, voVarWiPerdict, vIsWeightedPrediction);
}

//****************************************************************************************************
//FUNCTION:
float hiveRegressionForest::hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, unsigned int vNumOfUsingTrees, float& voKnnPredictSet,   float& voVarWiPerdict, bool vIsWeightedPrediction)
{
	_ASSERT(!vTestInstance.empty());
	...
	return pRegressionForest->predict(vTestInstance, vNumOfUsingTrees, voKnnPredictSet, voVarWiPerdict, vIsWeightedPrediction);

}
//****************************************************************************************************
//FUNCTION:
float hiveRegressionForest::hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, unsigned int vNumOfUsingTrees, float& voLPPredictSet, float& voMPPredictSet, float& voLLPerdict, float& voLLPSet, float& voMPDissimilarity, float& voIFMPPerdict, bool vIsWeightedPrediction)
{
	_ASSERT(!vTestInstance.empty());
	...
	return pRegressionForest->predict(vTestInstance, vNumOfUsingTrees, voLPPredictSet, voMPPredictSet, voLLPerdict,  voLLPSet, voMPDissimilarity,  voIFMPPerdict, vIsWeightedPrediction);
