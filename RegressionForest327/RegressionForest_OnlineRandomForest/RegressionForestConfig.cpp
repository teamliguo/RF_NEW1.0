...
void CRegressionForestConfig::__defineAcceptableAttributes()
{
	...
	defineAttribute(KEY_WORDS::INSTANCE_GET_METHOD_INTER,                   hiveConfig::ATTRIBUTE_INT);
	defineAttribute(KEY_WORDS::INSTANCE_NUMBER_INTER,                       hiveConfig::ATTRIBUTE_INT);
	defineAttribute(KEY_WORDS::INSTANCE_NUMBER_RATIO_INTER,                 hiveConfig::ATTRIBUTE_FLOAT);
	defineAttribute(KEY_WORDS::CALL_METHOD,                                 hiveConfig::ATTRIBUTE_INT);
	defineAttribute(KEY_WORDS::INSTANCE_GET_METHOD,                         hiveConfig::ATTRIBUTE_INT);
	defineAttribute(KEY_WORDS::INSTANCE_NUMBER,								hiveConfig::ATTRIBUTE_INT);
	defineAttribute(KEY_WORDS::INSTANCE_NUMBER_RATIO,                       hiveConfig::ATTRIBUTE_FLOAT);
	defineAttribute(KEY_WORDS::INSTANCE_BY_WEIGHT,                          hiveConfig::ATTRIBUTE_INT);
	defineAttribute(KEY_WORDS::INSTANCE_COUNT_WEIGHT,                       hiveConfig::ATTRIBUTE_FLOAT);
	...
	defineAttribute(KEY_WORDS::IForestMP_GET_METHOD,                        hiveConfig::ATTRIBUTE_INT);
	defineAttribute(KEY_WORDS::IForestMP_INSTANCE_NUMBER,                   hiveConfig::ATTRIBUTE_INT);
	defineAttribute(KEY_WORDS::IForestMP_NUMBER_RATIO,                      hiveConfig::ATTRIBUTE_FLOAT);
