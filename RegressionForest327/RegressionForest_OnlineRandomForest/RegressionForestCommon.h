...
namespace hiveRegressionForest
{
	namespace KEY_WORDS
	{
		...
		//Select instance of inter node to predict
		const std::string INSTANCE_GET_METHOD_INTER        = "INSTANCE_GET_METHOD_INTER";
		const std::string INSTANCE_NUMBER_INTER            = "INSTANCE_NUMBER_INTER";
		const std::string INSTANCE_NUMBER_RATIO_INTER      = "INSTANCE_NUMBER_RATIO_INTER";
		//Control call method
		const std::string CALL_METHOD                      = "CALL_METHOD";
		//Select instance to predict
		const std::string INSTANCE_GET_METHOD              = "INSTANCE_GET_METHOD";
		const std::string INSTANCE_NUMBER                  = "INSTANCE_NUMBER";
		const std::string INSTANCE_NUMBER_RATIO            = "INSTANCE_NUMBER_RATIO";
		const std::string INSTANCE_BY_WEIGHT               = "INSTANCE_BY_WEIGHT";
		const std::string INSTANCE_COUNT_WEIGHT            = "INSTANCE_COUNT_WEIGHT"; 
		const std::string IForestMP_INSTANCE_NUMBER        = "IForestMP_INSTANCE_NUMBER";
		const std::string IForestMP_NUMBER_RATIO           = "IForestMP_NUMBER_RATIO";
		const std::string IForestMP_GET_METHOD             = "IForestMP_GET_METHOD";
	}
}