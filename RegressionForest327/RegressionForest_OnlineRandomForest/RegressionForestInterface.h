...
namespace hiveRegressionForest
{
	...
	//for single response      
	REGRESSION_FOREST_EXPORTS float                     hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, float& voKnnPredictSet, float& voVarWiPerdict, bool vIsWeightedPrediction);
	REGRESSION_FOREST_EXPORTS float						hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, float& voLPPredictSet, float& voMPPredictSet, float& voLLPerdict, float& voLLPSet, float& voMPDissimilarity, float& voIFMPPerdict, bool vIsWeightedPrediction = true);
	REGRESSION_FOREST_EXPORTS float 					hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, unsigned int vNumOfUsingTrees, float& voLPPredictSet, float& voMPPredictSet, float& voLLPerdict, float& voLLPSet, float& voMPDissimilarity, float& voIFMPPerdict, bool vIsWeightedPrediction = true);
	REGRESSION_FOREST_EXPORTS float                     hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, unsigned int vNumOfUsingTrees, float& voKnnPredictSet, float& voVarWiPerdict, bool vIsWeightedPrediction);
