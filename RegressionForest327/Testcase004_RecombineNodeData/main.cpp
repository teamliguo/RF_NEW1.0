...
#include "../RegressionForest_RecombineNodeData/RegressionForestInterface.h"
#include "../RegressionForest_RecombineNodeData/RegressionForestCommon.h"
#include "../RegressionForest_RecombineNodeData/TrainingSet.h"
#include "../RegressionForest_RecombineNodeData/TrainingSetConfig.h"
#include "../RegressionForest_RecombineNodeData/TrainingSetCommon.h"
#include "../RegressionForest_RecombineNodeData/Utility.h"
...
void main()
{
	...
	try
	{
		...
		std::cout << "Inter KNN MP MSE: " << LPMSE << std::endl;
		std::cout << "Inter KNN MP R2Score: " << LPR2Score << std::endl;
		...
		StatisticalResultFile << "Inter KNN MP MSE: " << LPMSE << std::endl;
		StatisticalResultFile << "Inter KNN MP R2Score: " << LPR2Score << std::endl;
