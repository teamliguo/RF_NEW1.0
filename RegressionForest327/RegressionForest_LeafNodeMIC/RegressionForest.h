...
namespace hiveRegressionForest
{
	...
	public:
		...
		float   predict(const std::vector<float>& vFeatures, unsigned int vNumOfUsingTrees, float& voLPPredictSet, float& voMPPredictSet, float& voMPDissimilarity, bool vIsWeightedPrediction) const;
	...
	private:
		float __predictCertainResponse(const std::vector<float>& vFeatures, unsigned int vNumOfUsingTrees, bool vIsWeightedPrediction, float& voLPPredictSet, float& voMPPredictSet, float& voMPDissimilarity, unsigned int vResponseIndex = 0) const;
