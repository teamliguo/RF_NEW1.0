...
namespace hiveRegressionForest
{
	...
	//for single response
	REGRESSION_FOREST_EXPORTS float						hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, std::vector<std::vector<float>>& voTreePredictSet, std::vector<std::vector<float>>& voTreeDissimilarity, bool vIsWeightedPrediction = true);
	REGRESSION_FOREST_EXPORTS float 					hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, unsigned int vNumOfUsingTrees, std::vector<std::vector<float>>& voTreePredictSet, std::vector<std::vector<float>>& voTreeDissimilarity, bool vIsWeightedPrediction = true);
