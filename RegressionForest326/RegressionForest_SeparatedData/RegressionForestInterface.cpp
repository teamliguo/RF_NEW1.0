...
//****************************************************************************************************
//FUNCTION:
float hiveRegressionForest::hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, float& voMPPredictSet, float& voMPDissimilarity, bool vIsWeightedPrediction)
{
	...
	return hivePredict(vTestInstance, vForestId, pRegressionForest->getNumOfTrees(), voMPPredictSet, voMPDissimilarity, vIsWeightedPrediction);
}

//****************************************************************************************************
//FUNCTION:
float hiveRegressionForest::hivePredict(const std::vector<float>& vTestInstance, unsigned int vForestId, unsigned int vNumOfUsingTrees, float& voMPPredictSet, float& voMPDissimilarity, bool vIsWeightedPrediction)
{
	_ASSERT(!vTestInstance.empty());
	...
	return pRegressionForest->predict(vTestInstance, vNumOfUsingTrees, voMPPredictSet, voMPDissimilarity, vIsWeightedPrediction);
}
