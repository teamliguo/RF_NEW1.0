...
namespace hiveRegressionForest
{
	...
	public:
		...
		float   predict(const std::vector<float>& vFeatures, unsigned int vNumOfUsingTrees, std::vector<std::vector<float>>& voTreePredictSet, std::vector<std::vector<float>>& voTreeDissimilarity, bool vIsWeightedPrediction) const;
	...
	private:
		float __predictCertainResponse(const std::vector<float>& vFeatures, unsigned int vNumOfUsingTrees, bool vIsWeightedPrediction, std::vector<std::vector<float>>& voTreePredictSet, std::vector<std::vector<float>>& voTreeDissimilarity, unsigned int vResponseIndex = 0) const;
